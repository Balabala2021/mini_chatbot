  ...
  async function handleSendMessage() {
    if (input.trim() !== "") {
      try {
        ...
        await fetch(`https://jsonplaceholder.typicode.com/todos/${messageId}`)
    ...
    <>
      <div className="m-2 h-screen ">
        <div className="relative h-full">
          ...
          {open && (
            <div
              className={`absolute bottom-20 right-[5%] w-[400px] min-h-[450px] shadow-xl h-80 rounded-lg overflow-hidden
              bg-white transition-all duration-500 ease-in-out transform
              ${
                open
                  ? "animate-rotateOnce opacity-100 translate-y-0"
